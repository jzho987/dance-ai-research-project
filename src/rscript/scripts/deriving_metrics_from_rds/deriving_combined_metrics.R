...
# Save the final metrics to 'data/metrics/output/combined_metrics.rds'
saveRDS(final_metrics, file = "data/metrics/combined_metrics.rds")

# Save the final metrics to 'data/metrics/output/combined_metrics.csv' as a CSV file
write.csv(final_metrics, file = "data/metrics/combined_metrics.csv", row.names = FALSE)

# Save the final metrics to 'data/metrics/output/combined_metrics.xlsx' as an Excel file
write_xlsx(final_metrics, path = "data/metrics/combined_metrics.xlsx")
